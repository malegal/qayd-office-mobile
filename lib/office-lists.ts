...
export const getSessions = (officeId: string) => list<SessionRow>("sessions", officeId, "id, case_id, session_date, case_status, decision", "sessions", q => q.eq("office_id", officeId).order("session_date", { ascending: false }));
